...
public class NetWorkManager : MonoBehaviour
{
    ...
    private float localPositionSendTime = 0;
    ...
    void Update()
    {
        ...
        {
            if (Time.time - localPositionSendTime >= positionSendRate)
            {
                SendPositionUpdate();
                localPositionSendTime = Time.time;
            }
        }
    }
    ...
    private async void ConnectToServer()
    {
        ...
        webSocket.OnClose += (e) =>
        {
            ...
            AddToChatLog($"[시스템] 시스템 서버와의 연결이 끊어졌습니다. ");
    ...
    private async void SendPositionUpdate()
    {
        ...
        NetworkMessage message = new NetworkMessage()
        {
            ...
            rotation = new Vector3Data(localPlayer.localEulerAngles)
        };
